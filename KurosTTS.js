fetch("http://localhost:3000/api/cameras")
  ...
  .then(function(value){
    ...
    img.setAttribute("src", value[3].imageUrl); 
    ...
    title.textContent = value[3].name;
    cardBody.appendChild(description); 
    description.className = "card-text"; 
    description.textContent = value[3].description; 
    cardBody.appendChild(dropdownList);
    dropdownList.appendChild(optionOne); 
    dropdownList.appendChild(optionTwo); 
    optionOne.textContent = value[3].lenses[0]; 
    optionOne.setAttribute("value", value[3].lenses[0]);
    optionTwo.textContent = value[3].lenses[1]; 
    optionTwo.setAttribute("value", value[3].lenses[1]);
    ...
    amount.textContent = value[3].price + "$";
    quantity.addEventListener("input", function(e){
        amount.textContent = value[3].price * e.target.value + "$"
    })
