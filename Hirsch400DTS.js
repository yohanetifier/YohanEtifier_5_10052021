fetch("http://localhost:3000/api/cameras")
  ...
  .then(function(value){
    ...
    img.setAttribute("src", value[1].imageUrl); 
    ...
    title.textContent = value[1].name;
    cardBody.appendChild(description); 
    description.className = "card-text"; 
    description.textContent = value[1].description; 
    ...
    optionOne.textContent = value[1].lenses[0]; 
    optionOne.setAttribute("value", value[1].lenses[0]);
    optionTwo.textContent = value[1].lenses[1]; 
    optionTwo.setAttribute("value", value[1].lenses[1]);
    optionThree.textContent = value[1].lenses[2]; 
    optionThree.setAttribute("value", value[1].lenses[2])
    ...
    amount.textContent = value[1].price + "$";
    quantity.addEventListener("input", function(e){
        amount.textContent = value[1].price * e.target.value + "$"
    })
